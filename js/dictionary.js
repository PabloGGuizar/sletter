...
export const langData = {
    ...
    eu: {
        url: './data/eu.json',
        values: {'A':1, 'B':3, 'C':8, 'D':2, 'E':1, 'F':8, 'G':3, 'H':4, 'I':1, 'J':8, 'K':3, 'L':2, 'M':3, 'N':1, 'Ñ':8, 'O':1, 'P':3, 'Q':10, 'R':1, 'S':1, 'T':1, 'U':1, 'V':8, 'W':10, 'X':4, 'Y':10, 'Z':4},
        bag: "AAAAAAAAAAAAAAABBBDDDDEEEEEEEEEEEEGGGHHHIIIIIIIIIKKKKKLLLLMMMNNNNNNNNOOOOOOOPPPRRRRRRRSSSSSSTTTTTTUUUUUUXXXZZZZZCFJÑQVW"
    }
};
